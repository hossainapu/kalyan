...
public class ApplicationInfo implements Serializable {
    ...
    public ApplicationInfo(com.example.polls.model.ApplicationInfo applicationInfo) {
        super();
        if(applicationInfo != null) {
            ...
            try {
                ...
                BufferedImage p = Utils.resizeImage(ImageIO.read(bis),200,200);
                ...
                p = Utils.resizeImage(ImageIO.read(bis),200,200);
