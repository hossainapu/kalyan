...
public class OnlineApplicationInfo implements Serializable {
    ...
    public OnlineApplicationInfo(com.example.polls.model.OnlineApplicationInfo applicationInfoEO) {
        if(applicationInfoEO != null) {
            ...
            this.dateOfBirth = Utils.dateToString(applicationInfoEO.getDateOfBirth(), AppConstants.BIRTH_DATE_FORMAT);
    ...
    public OnlineApplicationInfo(Object[] result) {
        super();

        if(result != null && result.length >0) {
            this.id = Utils.getInteger(Utils.getValue(result,0));
            this.nameEn = (String)Utils.getValue(result,1);
            this.uuid = (String)Utils.getValue(result,2);
            this.contactNumber = (String)Utils.getValue(result,3);
            this.nid = (String)Utils.getValue(result,4);
            this.applicationType = (String)Utils.getValue(result,5);
            this.authorityCode =(String)Utils.getValue(result,6);
            this.circleCode = (String)Utils.getValue(result,7);
        }
    }
