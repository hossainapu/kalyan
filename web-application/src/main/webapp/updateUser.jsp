...
<div class="container container-fluid">
    <table class="table table-striped">
        ...
        <tbody>
        <form class="well form-horizontal" action="${contextPath}/user/update-user" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                                <input id="name" name="name" value="${user.name}" placeholder="নাম" class="form-control" required="true" type="text" maxlength="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">কন্ট্যাক্ট নম্বর<i class="text-danger">*</i></label>
                            <div class="col-md-8 inputGroupContainer">
                                <input id="contactNumber" name="contactNumber" value="${user.contactNumber}" placeholder="কন্ট্যাক্ট নম্বর" class="form-control" required="true" type="text" maxlength="100">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                                <input type="text" value="${user.email}" class="form-control" name="email" id="email" placeholder="ইমেইল এড্রেস" title="ইমেইল এড্রেস" maxlength="100">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                                <input type="text" value="${user.username}" class="form-control" name="username" id="username" placeholder="ইউজার নাম" title="ইউজার নাম" maxlength="50">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                                <input type="password" readonly="readonly" class="form-control" name="password" value="${user.password}" id="password" placeholder="পাসওয়ার্ড" title="পাসওয়ার্ড" maxlength="20">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                                <input type="password" readonly="readonly" class="form-control" name="passwordConfirm" value="${user.passwordConfirm}" id="passwordConfirm" placeholder="কন্ফার্ম পাসওয়ার্ড" title="কন্ফার্ম পাসওয়ার্ড" maxlength="20">
