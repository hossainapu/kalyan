...
<head>
    ...
    <title>আপলোড করা এপ্লিকেশনের ডিটেলস</title>
</head>
            ...
            <td class="col-sm-6">
                ...
                <fieldset>
                    <div class="form-group">
                        <label class="col-md-4 control-label">রেফারেন্স নম্বর&nbsp;</label>
                        <div class="col-md-8 inputGroupContainer">
                            <input id="referenceNumber" readonly="readonly" value="${application.referenceNumber}" placeholder="রেফারেন্স নম্বর" class="form-control" required="true" type="text" maxlength="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 inputGroupContainer">
                            <input type="text" class="form-control"  readonly="readonly" value="${application.emergencyContact}" id="emergencyNumber" placeholder="০১*********" title="ইমার্জেন্সি নম্বর" maxlength="11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 inputGroupContainer">
                            <input type="text" class="form-control" readonly="readonly" value="${application.numberOfEmiPaid}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 inputGroupContainer">
                            <input type="text" class="form-control" readonly="readonly" value="${application.officeCode}">
                        </div>
                    </div>
            ...
            <td class="col-sm-6">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 inputGroupContainer">
                            <input type="text" class="form-control" readonly="readonly" value="${application.presentThana}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 inputGroupContainer">
                            <input type="text" class="form-control" readonly="readonly" value="${application.permanentThana}">
                        </div>
                    </div>
