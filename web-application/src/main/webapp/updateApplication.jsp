    ...
    <script>
        $(document).ready(function() {
            ...
            $("#idGoBack").click(function (ev) {
                ev.preventDefault();
                window.location.href = "${contextPath}/admin/search-uploaded-application"
            });
        });
    </script>
        ...
        <div class="container container-fluid">
            <table class="table table-striped">
                <tbody>
                    ...
                    <form class="well form-horizontal" action="${contextPath}/admin/update-application" method="post" id="applicationForm" enctype="multipart/form-data">
                        <tr>
                            <td class="col-sm-6">
                                <h4>অ্যাপ্লিকেশন এনরোলমেন</h4>
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">রেফারেন্স নম্বর&nbsp;<i class="text-danger">*</i></label>
                                        <div class="col-md-8 inputGroupContainer">
                                            <input id="referenceNumber" name="referenceNumber" value="${application.referenceNumber}" placeholder="রেফারেন্স নম্বর" class="form-control" required="true" type="text" maxlength="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 inputGroupContainer">
                                            <input type="text" class="form-control" name="emergencyContact" value="${application.emergencyContact}" id="emergencyContact" placeholder="০১*********" title="ইমার্জেন্সি নম্বর" maxlength="11">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 inputGroupContainer">
                                            <select class="selectpicker form-control" name="numberOfEmiPaid" id="numberOfEmiPaid">
                                                <option value="">--পছন্দ করুন--</option>
                                                <option value="0" <c:out value="${application.numberOfEmiPaid ==1 ? 'selected=\"selected\"' : ''}"/>>০</option>
                                                <option value="1" <c:out value="${application.numberOfEmiPaid ==1 ? 'selected=\"selected\"' : ''}"/>>১</option>
                                                <option value="2" <c:out value="${application.numberOfEmiPaid ==2 ? 'selected=\"selected\"' : ''}"/>>২</option>
                                                <option value="3" <c:out value="${application.numberOfEmiPaid ==3 ? 'selected=\"selected\"' : ''}"/>>৩</option>
                                                <option value="4" <c:out value="${application.numberOfEmiPaid ==4 ? 'selected=\"selected\"' : ''}"/>>৪</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 inputGroupContainer">
                                            <select class="selectpicker form-control" name="officeCode" id="officeCode">
                                                <option value="">--পছন্দ করুন--</option>
                                                <option value="GCC" <c:out value="${application.officeCode =='GCC' ? 'selected=\"selected\"' : ''}"/>>গাজীপুর সিটি কর্পোরেশন</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <td class="col-sm-6">
                                            ...
                                            <select class="form-control" name="presentUpozila" id="presentUpozila">
                                                ...
                                                <c:if test="${presentUpozilas != null && presentUpozilas.size() >0}">
                                                    <c:forEach items="${presentUpozilas}" var="up" varStatus="loop">
                                                        <option value="${up.name}" <c:out value="${up.name ==application.presentThana? 'selected=\"selected\"' : ''}"/>>${up.name}</option>
                                                    </c:forEach>
                                                </c:if>
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control" id="permanentUpozila" name="permanentUpozila">
                                                ...
                                                <c:if test="${permanentUpozilas != null && permanentUpozilas.size() >0}">
                                                    <c:forEach items="${permanentUpozilas}" var="up" varStatus="loop">
                                                        <option value="${up.name}" <c:out value="${up.name ==application.permanentThana? 'selected=\"selected\"' : ''}"/>>${up.name}</option>
                                                    </c:forEach>
                                                </c:if>
                                            </select>
                                        </div>
                                ...
                                <input type="button" id="idGoBack" class="btn btn-primary" value="পিছনে">
