    ...
    <body class="bg-primary">
        ...
        <div class="container container-fluid">
            <table class="table table-striped">
                ...
                <tbody>
                <form class="well form-horizontal" action="${contextPath}/user/create-user" method="post" id="applicationForm" enctype="multipart/form-data">
                    <tr>
                        <td class="col-sm-3"></td>
                        <td class="col-sm-6">
                            <h4>ইউজার তৈরী করুন</h4>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 inputGroupContainer">
                                        <input type="text" value="${user.username}" class="form-control" name="username" id="nid" placeholder="ইউজার নাম" title="ইউজার নাম" maxlength="50">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 inputGroupContainer">
                                        <input type="submit" class="form-control btn btn-primary" value="সেভ">
                                    </div>
                                    <div class="col-sm-4">
