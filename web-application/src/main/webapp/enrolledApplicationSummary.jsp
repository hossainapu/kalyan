...
<html>
    ...
    <body class="bg-primary">
        ...
        <div class="container container-fluid" style="background-color: white">
            <form role="form" method="post" action="/admin/application-search">
                <div class="row">
                    <div class="col-sm-4">
                ...
                <tbody>
                    <c:forEach items="${applications}" var="app" varStatus="loop">
                        <tr>
                            ...
                            <td>${app.authority}</td>
                            <td><p data-placement="top" data-toggle="tooltip" title="View"><a class="btn btn-primary btn-xs" href="/admin/viewEnrolledApplication/${app.id}" ><span class="glyphicon glyphicon-eye-open"></span></a></p></td>
                        </tr>
                    </c:forEach>
