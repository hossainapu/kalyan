...
public class BaseRepository {
    ...
    public <T> List<T> findAll(Class<T> entity) {
        String sql = "select o from "+entity.getSimpleName()+" o where 1=1 order by o.nameEn ASC ";
    ...
    public List<Object[]> findByNativeQuery(String sql,Map<String,Object> param) {
        if(Utils.isEmpty(sql)) {
            return new ArrayList<>();
        }
    ...
    public <T> T findSingleResultByNativeQuery(String sql,Class<T> entity,Map<String,Object> param) {
    ...
    public <T> List<T> findByJpql(String jpql,Class<T> entity,Map<String,Object> param) {
        Query query = em.createQuery(jpql,entity);
        if(param != null && param.size() >0) {
            param.forEach((k,v)->{
                query.setParameter(k,v);
            });
